...
export interface SteamInventoryItem {
  ...
  appid?: number // Application ID (730 for CS2, 570 for Dota 2)
  price?: {
    lowest_price?: string
    median_price?: string
    mnt_lowest_price?: string
    mnt_median_price?: string
    volume?: string
    market_url?: string
  } // Price information
}
...
// Price information from Steam Market
export interface MarketPriceInfo {
  success: boolean
  lowest_price: string | null
  median_price: string | null
  mnt_lowest_price: string | null
  mnt_median_price: string | null
  volume: string | null
